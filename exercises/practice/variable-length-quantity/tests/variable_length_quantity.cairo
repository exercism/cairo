mod encode {
    use variable_length_quantity::encode;
    ...
    fn asymmetric_single_byte() {
        let integers = array![83];
        let expected = array![83];
    ...
    fn asymmetric_double_byte() {
        let integers = array![173];
        let expected = array![129, 45];
    ...
    fn asymmetric_triple_byte() {
        let integers = array![120220];
        let expected = array![135, 171, 28];
    ...
    fn asymmetric_quadruple_byte() {
        let integers = array![3503876];
        let expected = array![129, 213, 238, 4];
    ...
    fn asymmetric_quintuple_byte() {
        let integers = array![2254790917];
        let expected = array![136, 179, 149, 194, 5];
...
mod decode {
    use variable_length_quantity::decode;
